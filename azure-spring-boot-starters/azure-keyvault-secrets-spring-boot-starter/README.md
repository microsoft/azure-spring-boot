...
## Sample Code
Pls refer to [sample project here](../../azure-spring-boot-samples/azure-keyvault-secrets-spring-boot-starter-sample).
...
```
> NOTE
> To get detail steps on how setup Azure Key Vault, please refer to sample code readme section ["Setup Azure Key Vault"](../../azure-spring-boot-samples/azure-keyvault-secrets-spring-boot-starter-sample/README.md)
