...
Add below alike code to autowire the clients you want to use in your application. You can reference the sample code in azure-servicebus-spring-boot-starter-sample folder.
