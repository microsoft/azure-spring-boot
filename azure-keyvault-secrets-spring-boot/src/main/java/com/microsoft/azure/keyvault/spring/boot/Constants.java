...
public class Constants {
    ...
    public static final String AZURE_KEYVAULT_PROERTYSOURCE_NAME = "azurekv";
    public static final String AZURE_TOKEN_ACQUIRING_TIMEOUT_IN_SECONDS = "azure.token.acquiring.timeout.seconds";
}
