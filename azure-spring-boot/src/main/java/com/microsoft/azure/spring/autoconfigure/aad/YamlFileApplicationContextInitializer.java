...
public class YamlFileApplicationContextInitializer
    ...
    private List<PropertySource<?>> yamlPropertySourceLoad(ConfigurableApplicationContext context) throws IOException {
        ...
        final List<PropertySource<?>> serviceEndpoints = sourceLoader.load("serviceEndpoints", resource);
