...
public class Constants {
    ...
    public static final String AZURE_KEYVAULT_CERTIFICAT_PATH = "azure.keyvault.certificate.path";
    public static final String AZURE_KEYVAULT_CERTIFICAT_PASSWORD = "azure.keyvault.certificate.password";
