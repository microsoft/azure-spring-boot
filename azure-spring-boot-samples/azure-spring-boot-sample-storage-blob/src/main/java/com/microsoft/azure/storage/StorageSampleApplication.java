...
public class StorageSampleApplication implements CommandLineRunner {
    ...
    public void run(String... var1) throws IOException {
        ...
        final BlobContainerService containerService = new BlobContainerService(blobContainerAsyncClient);
        final BlobService blobService = new BlobService(blobContainerAsyncClient.getBlobAsyncClient(SOURCE_FILE));
        ...
        while (!isExit) {
            ...
            switch(input) {
                ...
                case "E":
                    ...
                    final boolean delete = downloadToFile.delete();
                    if (!delete) {
                        System.err.println("Fail to delete file...");
                    }
                    isExit = true;
                    break;
                default:
