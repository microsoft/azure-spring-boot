...
## Version management
Developing version naming convention is like `0.1.5-SNAPSHOT`. Release version naming convention is like `0.1.5`. Please don't update version if no release plan. 
